...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/flatten-a-multilevel-doubly-linked-list/)
...
**My Solution:** [430-Flatten-a-Multilevel-Doubly-Linked-List.java](./430-Flatten-a-Multilevel-Doubly-Linked-List.java)
