...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/next-greater-node-in-linked-list/)
...
**My Solution:** [1019-Next-Greater-Node-In-Linked-List.java](./1019-Next-Greater-Node-In-Linked-List.java)
